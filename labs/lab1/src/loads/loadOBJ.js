				...
				.load(name + '.obj', function (object) {
					object.traverse(function (child) {
						if (child.isMesh) {
							...
							let Rotation = [transform.modelRotX, transform.modelRotY, transform.modelRotZ];
							...
							for(let i = 0; i < renderer.lights.length; i++){
								...
								switch (objMaterial) {
									case 'PhongMaterial':
										material = buildPhongMaterial(colorMap, mat.specular.toArray(), light, Translation, Rotation, Scale, "./src/shaders/phongShader/phongVertex.glsl", "./src/shaders/phongShader/phongFragment.glsl", i);
										shadowMaterial = buildShadowMaterial(light, Translation, Rotation, Scale, "./src/shaders/shadowShader/shadowVertex.glsl", "./src/shaders/shadowShader/shadowFragment.glsl", i);
										break;
								}
								material.then((data) => {
